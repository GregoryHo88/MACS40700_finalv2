...
# Create combined scatterplot with ggplot2
gg_plot <- ggplot(long_data, aes(x = Percentage, y = poverty_rate, color = Indicator)) +
  geom_point(alpha = 0.7) +
  geom_smooth(method = "lm", se = TRUE) +  # Linear trendline with SEs
  ...
  labs(title = "Poverty Rate vs Digital Divide Indicators",
       ...
       y = "Poverty Rate",
       color = "Indicator") +
  scale_color_manual(values = c("Pct_No_Computer" = "#1f77b4", "Pct_No_Internet" = "#ff7f0e")) +
  theme_minimal() +
  theme(strip.background = element_blank(),
        strip.text.x = element_text(size = 12, face = "bold"),
        legend.position = "bottom")

# Convert ggplot2 plot to plotly for interactivity
plotly_plot <- ggplotly(gg_plot) %>%
  layout(title = "Poverty Rate vs Digital Divide Indicators",
         ...
         annotations = list(
           list(
             ...
             y = -0.15,
             showarrow = FALSE,
             text = "Higher values indicate higher deprivation levels.",
             xref = "paper",
             yref = "paper"
           )
         ))
...
htmlwidgets::saveWidget(plotly_plot, "interactive_figure3.html")
```

<iframe src="interactive_figure3.html" width="100%" height="600"></iframe>
