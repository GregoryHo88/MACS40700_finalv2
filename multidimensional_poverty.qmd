...
loadings_df <- loadings_df %>%
  rename(
    'Adults 25 above that did not finish schooling' = Pct_Adults_No_HighSchool,
    'Adults without health insurance' = Pct_No_Insurance,
    'Unemployed' = Pct_Unemployed,
    'No Plumbing' = Pct_No_Plumbing,
    'Receiving public assistance' = Pct_Receiving_PA,
    'Not in Labor Force' = Pct_Not_In_Labor_Force,
    'Disabled' = Pct_Disabled,
    'No Computer' = Pct_No_Computer,
    'No Internet Access' = Pct_No_Internet,
    'House-Cost burdened' = Pct_Cost_Burdened_Housing,
    'Kids not enrolled in school' = Pct_Kids_Not_In_School,
    'No internet subscription' = Pct_Internet_No_Subscription,
    'House Overcrowded' = Pct_Overcrowded_Housing,
    'Youth neither attending school nor work' = Pct_Youth_Not_In_School_Not_Working,
    'No kitchen facility' = Pct_No_Kitchen
  )
...
ggplot(loadings_long, aes(Variable, abs(Loading), fill=Loading)) + 
  ...
  theme(
    ...
    panel.spacing = unit(0.33, "lines"), # adjust spacing between facets
    plot.margin = margin(8, 4, 4, 4) # adjust overall plot margins (top, right, bottom, left)
  )
```
